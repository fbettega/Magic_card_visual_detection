...
back_references = [os.path.join("data", "other_file", "default_back.jpg"),os.path.join("data", "other_file", "default_back2.jpg")]
...
Base_data_method().move_card_backs_parallel(images_dir, back_references, bad_images_dir)
